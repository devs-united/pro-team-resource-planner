package hr.proteam.repository;

import hr.proteam.ProTeamResourcePlannerApp;
import hr.proteam.config.Constants;
import hr.proteam.config.audit.AuditEventConverter;
import hr.proteam.domain.PersistentAuditEvent;
...
import static hr.proteam.repository.CustomAuditEventRepository.EVENT_DATA_COLUMN_MAX_LENGTH;
