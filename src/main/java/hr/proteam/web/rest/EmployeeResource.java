...
import hr.proteam.domain.Address;
import hr.proteam.domain.Employee;
import hr.proteam.service.EmployeeService;
...
/**
 * REST controller for managing {@link hr.proteam.domain.Employee}.
 */
@RestController
@RequestMapping("/api")
