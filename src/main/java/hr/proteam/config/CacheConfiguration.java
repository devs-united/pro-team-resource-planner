...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, hr.proteam.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, hr.proteam.repository.UserRepository.USERS_BY_EMAIL_CACHE);
